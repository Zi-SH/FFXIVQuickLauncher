...
class Program
{
    ...
    public static void CreateCompatToolsInstance()
    {
        ...
        CompatibilityTools = new CompatibilityTools(wineSettings, Config.DxvkHudType, Config.DxvkFrameRate, Config.GameModeEnabled, Config.DxvkAsyncEnabled, toolsFolder);
    }
